...
//  SendMessageResponse reply = sender.SendMessage( msg );
  std::cout << "Client received error message id: " << reply.message_id() << std::endl;
  messaging::ErrorInfo error_info = reply.error();
  std::cout << "Client received error message: " << error_info.error_message() << std::endl;
  std::cout << "Client received error message: " << error_info.response_code() << std::endl;
